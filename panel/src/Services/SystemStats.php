...
/**
 * Reads system metrics directly (no privileges needed).
 * Degrades gracefully on non-Linux dev machines.
 */
final class SystemStats
{
    ...
    public function snapshot(): array
    {
        return [
            ...
            'os' => PHP_OS_FAMILY === 'Linux' ? trim((string) @file_get_contents('/etc/issue.net')) : php_uname('s'),
        ];
    }
    ...
    /** @return array{total_mb: int, used_mb: int, percent: int} */
    ...
    /** @return array{total_gb: float, used_gb: float, percent: int} */
