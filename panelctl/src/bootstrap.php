...
final class Dispatcher
{
    ...
    public static function map(): array
    {
        return [
            ...
            'db:info' => [DbCommands::class, 'info'],
            'db:check' => [DbCommands::class, 'check'],
            'db:repair' => [DbCommands::class, 'repair'],
            'db:optimize' => [DbCommands::class, 'optimize'],
            ...
            'db:user:privileges' => [DbCommands::class, 'userPrivileges'],
